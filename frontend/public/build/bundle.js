...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			t2 = text(t2_value);
    			attr_dev(div, "class", div_class_value = "color-" + /*piece*/ ctx[0].color + " square-" + /*piece*/ ctx[0].position + " svelte-ck5o87");
    			toggle_class(div, "is-selected", /*isSelected*/ ctx[1]);
    			add_location(div, file$1, 270, 0, 3625);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*piece*/ 1 && div_class_value !== (div_class_value = "color-" + /*piece*/ ctx[0].color + " square-" + /*piece*/ ctx[0].position + " svelte-ck5o87")) {
    ...
    // (44:12) {#each columns as column (column)}
    function create_each_block_2(key_1, ctx) {
    	let div;
    	let t0_value = /*column*/ ctx[14] + "";
    	let t0;
    	let t1_value = /*row*/ ctx[11] + "";
    	let t1;

    	function func(...args) {
    		return /*func*/ ctx[6](/*column*/ ctx[14], /*row*/ ctx[11], ...args);
    	}
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 44, 16, 914);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(44:12) {#each columns as column (column)}",
    		ctx
    	});
    ...
    function create_each_block_1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 42, 8, 826);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(42:4) {#each rows as row (row)}",
    		ctx
    	});
    ...
    // (54:4) {#if chessboardPieces && chessboardPieces.length > 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 54, 8, 1266);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(54:4) {#if chessboardPieces && chessboardPieces.length > 0}",
    		ctx
    	});
    ...
    // (56:12) {#each chessboardPieces as piece}
    function create_each_block(ctx) {
    	let piece;
    	let current;

    	function click_handler() {
    		return /*click_handler*/ ctx[7](/*piece*/ ctx[8]);
    	}

    	piece = new Piece({
    			props: {
    				piece: /*piece*/ ctx[8],
    				isSelected: /*selectedPiece*/ ctx[1]?.position === /*piece*/ ctx[8].position
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const piece_changes = {};
    			if (dirty & /*chessboardPieces*/ 1) piece_changes.piece = /*piece*/ ctx[8];
    			if (dirty & /*selectedPiece, chessboardPieces*/ 3) piece_changes.isSelected = /*selectedPiece*/ ctx[1]?.position === /*piece*/ ctx[8].position;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(56:12) {#each chessboardPieces as piece}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 40, 0, 753);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*columns, availableMoves, rows*/ 52) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Chessboard> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*availableMoves*/ 4) {
    ...
    class Chessboard extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*chessboardPieces*/ ctx[0] === undefined && !('chessboardPieces' in props)) {
    			console_1$1.warn("<Chessboard> was created without expected prop 'chessboardPieces'");
    		}

    		if (/*selectedPiece*/ ctx[1] === undefined && !('selectedPiece' in props)) {
    			console_1$1.warn("<Chessboard> was created without expected prop 'selectedPiece'");
    		}

    		if (/*availableMoves*/ ctx[2] === undefined && !('availableMoves' in props)) {
    			console_1$1.warn("<Chessboard> was created without expected prop 'availableMoves'");
    		}
    	}
    ...
    class Pawn extends ChessPieceAbstract {
        ...
        getAvailablePositions(pieces) {
            ...
            if (this.isStartingPosition()) {
                return [this.position + direction, this.position + (direction * 2)];
            }
            return [];
        }
        isStartingPosition() {
    ...
    const defaultChessboardWithPieces = [
        ...
        new Rook(PieceColor.WHITE, 11),
        new Rook(PieceColor.WHITE, 81),
        ...
        new Rook(PieceColor.BLACK, 18),
        new Rook(PieceColor.BLACK, 88),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<GameDetail> was created with unknown prop '${key}'`);
    	});
